...
test_cases = [
    ...
    "乾隆十一年闰正月",
    "乾隆十一年元月五日",  # 测试元月和具体日期
    "乾隆十一年正月十五日",  # 测试正月和两位数日期
    "乾隆十一年闰二月二十日"  # 测试闰月和具体日期
]
...
print(convert_to_gregorian("乾隆十一年闰十二月"))  # 输出：1746:12:0
print(convert_to_gregorian("乾隆十一年"))          # 输出：1746:0:0
print(convert_to_gregorian("康熙六十一年正月"))    # 输出：1722:1:0